> **CAMINHO SUSPENSO — arquivo de registro, não é doutrina ativa.**
>
> Este é o texto integral do agente `render-agroshow` enquanto o projeto era um
> mapa animado em 2.5D. O caminho ativo passou a ser a cena 3D em Blender, e o
> agente foi reescrito em 13/08/2026. Nada aqui vale como regra hoje.
